...
---*/
use role accountadmin;
create DATABASE IDENTIFIER('"FROSTBYTE_WEATHERSOURCE"') 
FROM SHARE IDENTIFIER('WEATHERSOURCE.SNOWFLAKE_MANAGED$PUBLIC_AWS_EU_CENTRAL_1."WEATHERSOURCE_SNOWFLAKE_GOLDEN_DEMO_TILE_SNOWFLAKE_SECURE_SHARE_1658944269021"');
